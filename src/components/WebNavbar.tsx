    ...
    <nav>
      <div className='container py-4 flex justify-between items-center'>
        ...
        <div className='flex items-center gap-4'>
          <Link href={'/applications'} className={'font-medium text-sm hover:underline p-2'}>Applications</Link>
          <Link href={'/companies'} className={'font-medium text-sm hover:underline p-2'}>Companies</Link>
